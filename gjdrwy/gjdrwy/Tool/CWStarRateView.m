...
#define FOREGROUND_STAR_IMAGE_NAME @"评论页面_五角星黄.png"
#define BACKGROUND_STAR_IMAGE_NAME @"评论页面_灰五角星.png"
...
- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars alloeTouch:(BOOL)touch
{
    if (self = [super initWithFrame:frame]) {
        _numberOfStars = numberOfStars;
        [self buildDataAndUI:YES];
...
- (void)buildDataAndUI:(BOOL)allowTouch{
